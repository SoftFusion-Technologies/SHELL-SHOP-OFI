    ...
    <footer className="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
        ...
        <div className="flex justify-center">
          ...
          <a
            href="https://www.instagram.com/shellshopm/"
            target="_blank"
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-4">
              <a href="#productos">Café</a>
            </p>
            <p className="mb-4">
              <a href="#productos">Tostadas</a>
            </p>
            <p className="mb-4">
              <a href="#productos">Pizzas</a>
            </p>
            <p>
              <a href="#productos">Sandwiches</a>
            </p>
          </div>
          <div>
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">
