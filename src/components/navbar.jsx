      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex flex-col mt-4 pr-5 md:flex-row md:gap-20 md:mt-0 md:text-sm md:font-medium lg:text-base">
            <li>
              <a href="/" className="block py-2 pr-4 pl-3 text-red rounded md:bg-transparent md:p-0 transition hover:text-red">
              Home
              </a>
            </li>
            <li>
              <a href="/nosotros" className="block py-2 pr-4 pl-3 text-red rounded md:bg-transparent md:p-0 transition hover:text-red">
              Nosotros
              </a>
            </li>
            <li>
              <a href="/contacto" className="block py-2 pr-4 pl-3 text-red rounded md:bg-transparent md:p-0 transition hover:text-red">
              Contacto
              </a>
            </li>
          </ul>
